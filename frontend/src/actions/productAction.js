...
export const getProduct = (keyword="", currentPage=1, price=[10000,500000], category, ratings=0)=>async (dispatch)=>{
        try {
...
export const createProduct = (productData) => async (dispatch) => {
  try {
    ...
    dispatch({
      ...
      payload: data,  // ? if we sending 'data' in payload then how we can access payload.product in reducer... check it up
    });
  } catch (error) {
    dispatch({
